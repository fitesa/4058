...
var style_EvolucionIndicedeHumedad_1 = function(feature, resolution){
    ...
    if (value >= -0.018352 && value <= 0.031526) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.031526 && value <= 0.081404) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.081404 && value <= 0.131282) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.131282 && value <= 0.181160) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.181160 && value <= 0.231038) {
            style = [ new ol.style.Style({
